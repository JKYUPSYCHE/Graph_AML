...
def _resolve_file(
    ...
    resolved = ml_00_ml_io.resolve_project_path(path, project_root)
...
def load_selected_feature_rows(
    ...
    *,
    ...
    feature_check = ml_00_ml_io.check_feature_columns_file(
    ...
    selected_mask = ml_00_ml_io.parse_used_in_ml(feature_table["used_in_ml"])
...
def validate_split_schemas(
    ...
    *,
    ...
    for split_name, split_path in split_paths.items():
        ...
        if split_path is None:
            continue        
        schema_names = set(ml_00_ml_io.get_parquet_columns(split_path)) # parquet 컬럼명만 읽어 schema 검증을 수행한다.
...
def preview_ml_inputs(
    ...
    *,
    ...
    ml_00_ml_io.require_input_files(paths, require_test=True)
    ...
    return MLInputPreview(
        ...
        feature_columns_hash=ml_00_ml_io.feature_columns_hash(feature_columns),
