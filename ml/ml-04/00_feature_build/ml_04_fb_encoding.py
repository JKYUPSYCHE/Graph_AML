"""ML-04 FB encoding/export helpers.

The generated ML-04 features are numeric, but this module preserves the ML-03
...
from ml_04_fb_catalog import make_split_summary
from ml_04_fb_io import (
...
from ml_04_fb_encoding_materialize import (
...
from ml_04_fb_encoding_outputs import (
    OUTPUT_PATH_FIELDS,
    SPLIT_PATH_FIELDS,
    EncodingOutputPaths,
...
from ml_04_fb_encoding_specs import (
    ENCODE_ENCODINGS,
...
def _supplement_missing_source_columns(
    ...
    *,
    ...
    print(
        "[ML-04 encoding] loading missing source columns "
