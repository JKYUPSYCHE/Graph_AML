"""Feature contract helpers for ML-04 FB input files.
...
- Notes: action/encoding normalization delegates to ml_04_fb_encoding_specs.
"""
...
from ml_04_fb_io import parquet_columns
