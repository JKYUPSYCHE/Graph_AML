"""ML-04 feature build artifact assembly helpers.

The ML-04 input is expected to be the ML-03 feature parquet. This module
preserves all input columns and appends only newly generated Stage 3 features.
...
from ml_04_fb_io import utc_now_iso
from ml_04_fb_operations import execute_feature_specs
from ml_04_fb_specs import FeatureSpec, feature_columns
...
def append_generated_features(
    ...
    """Append generated ML-04 feature columns without overwriting inputs."""
