"""Encoding spec parsing and normalization for ML-04 FB export.
...
from ml_04_fb_schema import META_COLUMNS, validate_no_forbidden_feature_columns, validate_no_forbidden_input_columns
