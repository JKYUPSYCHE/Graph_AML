...
def _run_study(
    ...
    *,
    ...
    def objective(trial: Any) -> float:
        ...
        trial.set_user_attr("metrics_train_path", str(val_result.metrics_train_path))
...
def _resolve_best_params(best_trial: Any, study_best_params: dict[str, Any]) -> dict[str, Any]:
    ...
    best_params.setdefault("early_stopping_rounds", 35)
    ...
    save_json(
        {
            ...
            "final_metrics_train_path": str(val_result.metrics_train_path),
