"""ML-03 feature build artifact assembly helpers.

The ML-03 input is expected to be the ML-02 feature parquet. This module
preserves all input columns and appends only newly generated Stage 2 features.
...
from ml_03_fb_io import utc_now_iso
from ml_03_fb_operations import execute_feature_specs
from ml_03_fb_specs import FeatureSpec, feature_columns
...
def append_generated_features(
    ...
    """Append generated ML-03 feature columns without overwriting inputs."""
