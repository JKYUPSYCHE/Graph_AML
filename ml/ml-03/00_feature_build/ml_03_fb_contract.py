"""Feature contract helpers for ML-03 FB input files.
...
- Notes: action/encoding normalization delegates to ml_03_fb_encoding_specs.
"""
...
from ml_03_fb_io import parquet_columns
