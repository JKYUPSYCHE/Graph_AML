"""Output path and export validation helpers for ML-05 FB encoding.
...
from ml_05_fb_io import parquet_columns, parquet_row_count, parquet_schema_types, resolve_path
...
def make_encoding_output_paths(output_dir: Union[str, Path], artifact_prefix: str) -> EncodingOutputPaths:
    """Create output paths for ML-05 encoding/export artifacts."""
