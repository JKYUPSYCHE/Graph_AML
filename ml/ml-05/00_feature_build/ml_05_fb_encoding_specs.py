"""Encoding spec parsing and normalization for ML-05 FB export.
...
from ml_05_fb_schema import META_COLUMNS, validate_no_forbidden_feature_columns, validate_no_forbidden_input_columns
